...
-   The ideal dataset should contain an indicator whether it is a fraud transaction, which is necessary for applying supervised machine learning methods. It should also contains data about the transactions, e.g. transaction details, customer details, etc., which could be used to classify the fraud transaction.
