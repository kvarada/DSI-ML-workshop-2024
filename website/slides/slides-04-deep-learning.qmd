...
- There are three common ways to use transfer learning in computer vision 
    1. Pre-trained models out-of-the-box 
    2. Pre-trained models as feature extractor and training your own model with these features
