...
## NLP pipelines before LLMs
\

- Text preprocessing: Tokenization, stopword removal, stemming/lemmatization.
- **Feature extraction**: Techniques Bag of Words or word embeddings (e.g., Word2Vec, GloVe).
- Modeling: A relatively simple model such as logistic regression or support vector machines (SVM)
